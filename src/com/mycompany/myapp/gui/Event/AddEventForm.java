...
pickerContainer.add(BorderLayout.CENTER, dateTimePicker);*/
        ...
        TextField descritionField = new TextField("", "description");
        TextField capaciteField = new TextField("", "capacite");
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((nomField.getText().length() == 0)&&(lieuField.getText().length() == 0)
                    ...
                    try {
                        ...
                        Evenement t = new Evenement(nom, lieu, description, formattedDatebegin, formattedDatefinish, capacite, prix, type);
           //Evenement t = new Evenement();

                       System.err.println("l'erreur dans le form2");
                        if (new Evenement_Service().addEvenement(t)) {
